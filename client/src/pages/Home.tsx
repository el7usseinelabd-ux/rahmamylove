  ...
  return (
    <main dir="rtl" className="min-h-screen overflow-hidden bg-ink text-ivory selection:bg-berry/30 redesigned-home">
      ...
      <header className="site-header">
        ...
        <nav className="site-nav" aria-label="التنقل الرئيسي"><button onClick={() => scrollTo("letters")}>رسائل</button><button onClick={() => scrollTo("memories")}>صور</button><button onClick={() => scrollTo("promise")}>وعد</button></nav>
